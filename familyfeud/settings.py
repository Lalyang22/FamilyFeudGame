"""
Django settings for FamilyFeud project.
...
SECRET_KEY = 'django-insecure-77^efulwr)3p_fxuz6#v_0e6nw$yl9y#(9%yr%9k%r72h(-3d2'
...
WSGI_APPLICATION = 'familyfeud.wsgi.application'
